<div class="t-header-brand-wrapper">
        ...
        <a href="index.html"
          ...
          <img
            class="logo-mini"
            src="https://uxcandy.co/demo/label_pro/preview/assets/images/logo_mini.svg"
            alt=""
          /> </a
        ><button
        ...
        <div class="t-header-content">
          ...
          <ul class="nav ml-auto">
            <li class="nav-item dropdown">
              ...
              ></a>
              <div
                class="dropdown-menu navbar-dropdown dropdown-menu-right"
                  ...
                  <div class="dropdown-list">
                    ...
                    <div class="content-wrapper">
                      ...
                      <small class="content-text"
                        >Server storage almost full</small
                      >
                    </div>
                  </div>
                  <div class="dropdown-list">
                    ...
                    <div class="content-wrapper">
                      ...
                      <small class="content-text"
                        >3 Files uploded successfully</small
                      >
                    </div>
                  </div>
                  <div class="dropdown-list">
            ...
            <li class="nav-item dropdown">
              <a
                ...
                <span
                  class="notification-indicator notification-indicator-primary notification-indicator-ripple"
                ></span
              ></a>
              <div
                class="dropdown-menu navbar-dropdown dropdown-menu-right"
                ...
                <div class="dropdown-body">
                  <div class="dropdown-list">
                    <div class="image-wrapper">
                      ...
                      />
                      <div
                        class="status-indicator rounded-indicator bg-success"
                      ></div>
                    </div>
                    <div class="content-wrapper">
                  ...
                  <div class="dropdown-list">
                    <div class="image-wrapper">
                      ...
                      />
                      <div
                        class="status-indicator rounded-indicator bg-warning"
                      ></div>
                    </div>
                    <div class="content-wrapper">
              ...
              >
                ...
                <div class="dropdown-body border-top pt-0">
                  <a class="dropdown-grid"
                    ...
                    <span class="grid-tittle">Jira</span> </a
                  ><a class="dropdown-grid"
                    ><i class="grid-icon mdi mdi-trello mdi-2x"></i>
                    <span class="grid-tittle">Trello</span> </a
                  ><a class="dropdown-grid"
                    ><i class="grid-icon mdi mdi-artstation mdi-2x"></i>
                    <span class="grid-tittle">Artstation</span> </a
                  ><a class="dropdown-grid"
                    ><i class="grid-icon mdi mdi-bitbucket mdi-2x"></i>
                    <span class="grid-tittle">Bitbucket</span></a
                  >
                </div>
                <div class="dropdown-footer"><a href="#">View All</a></div>
              </div>
