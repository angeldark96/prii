    ...
    <ul class="navigation-menu">
        ...
        <li>
            ...
            <ul class="collapse navigation-submenu" id="sample-pages">
                <li>
                    <a
                            href="#authentication-pages"
                            data-toggle="collapse"
                            aria-expanded="false"
                    ><span class="link-title">Auth Pages</span></a
                    >
                    <ul
                            class="collapse navigation-submenu"
                    ...
                    >
                        ...
                        <li>
                            <a href="pages/sample-pages/login_2.html" target="_blank"
                            >Login 2</a
                            >
                        </li>
                        <li>
                            <a href="pages/sample-pages/login_3.html" target="_blank"
                            >Login 3</a
                            >
                        </li>
                    </ul>
                ...
                <li>
                    <a
                            ...
                            data-toggle="collapse"
                            aria-expanded="false"
                    ><span class="link-title">Error Pages</span></a
                    >
                    <ul class="collapse navigation-submenu" id="error-pages">
                        <li>
                            <a href="pages/sample-pages/error_1.html" target="_blank"
                            >Error 1</a
                            >
                        </li>
                        <li>
                        ...
                        <li>
                            <a href="pages/sample-pages/error_3.html" target="_blank"
                            >Error 3</a
                            >
                        </li>
                    </ul>
