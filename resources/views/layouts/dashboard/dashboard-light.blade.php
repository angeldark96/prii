            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6 equel-grid">
                    <div class="grid">
                        <div class="grid-body d-flex flex-column h-100">
                            <div class="wrapper">
                                <div class="d-flex justify-content-between">
                                    <div class="split-header">
                                        <img
                                                class="img-ss mt-1 mb-1 mr-2"
                                                src="https://uxcandy.co/demo/label_pro/preview/assets/images/social-icons/instagram.svg"
                                                alt="instagram"
                                        />
                                    ...
                                    <div class="wrapper">
                                        <button
                                                class="btn action-btn btn-xs component-flat pr-0"
                                                type="button"
                                        >
                                            <i
                                                    class="mdi mdi-access-point text-muted mdi-2x"
                                            ></i>
                                        </button>
                                        <button
                                                class="btn action-btn btn-xs component-flat pr-0"
                                        ...
                                        >
                                            <i
                                                    class="mdi mdi-cloud-download-outline text-muted mdi-2x"
                                            ></i>
                                        </button>
                                    </div>
                                </div>
                            ...
                            <div class="mt-auto">
                                <canvas
                                        class="curved-mode chartjs-chart"
                    ...
                    <div class="grid">
                        <div class="grid-body">
                            <div class="split-header">
                                ...
                                <span
                                        class="btn action-btn btn-xs component-flat"
                                        data-toggle="tooltip"
                                        data-placement="left"
                                        title="Available balance since the last week"
                                ><i
                                            class="mdi mdi-information-outline text-muted mdi-2x"
                                    ></i
                                    ></span>
                            </div>
                            ...
                            <div class="d-flex mt-2">
                                <div class="wrapper d-flex pr-4">
                                    <small class="text-success font-weight-medium mr-2"
                                    >USD</small
                                    >
                                    <small class="text-gray">$103,342.50</small>
                                </div>
                                <div class="wrapper d-flex">
                                    <small class="text-primary font-weight-medium mr-2"
                                    >EUR</small
                                    >
                            ...
                            <div class="d-flex flex-row mt-4 mb-4">
                                <button
                                        class="btn btn-outline-light text-gray component-flat w-50 mr-2"
                                        type="button"
                                >
                                    SEND
                                </button>
                                <button class="btn btn-primary w-50 ml-2" type="button">
                                    RECEIVE
                                </button>
                            </div>
                            <div class="d-flex mt-5 mb-3">
                                <small class="mb-0 text-primary"
                                >Recent Transaction (3)</small
                                >
                            </div>
                            <div
                    ...
                    <div class="grid widget-revenue-card">
                        <div class="grid-body d-flex flex-column h-100">
                            ...
                            <div class="mt-auto">
                                ...
                                <div class="w-50">
                                    <div
                                            class="d-flex justify-content-between text-muted mt-3"
                                    >
                ...
                <div class="col-md-8 equel-grid">
                    <div class="grid">
                        ...
                        <div class="table-responsive">
                            <table class="table table-hover table-sm">
                                ...
                                <tr>
                                    ...
                                    <td class="pl-md-0">
                                        <small class="text-black font-weight-medium d-block"
                                        >Charlie Hawkins</small
                                        >
                                        <span class="text-gray"
                                        ><span
                                                    class="status-indicator rounded-indicator small bg-success"
                                            ></span
                                            >Email Verified</span
                                        >
                                    </td>
                                    <td><small>9537537436</small></td>
                                ...
                                <tr>
                                    ...
                                    <td class="pl-md-0">
                                        ...
                                        <span class="text-gray"
                                        ><span
                                                    class="status-indicator rounded-indicator small bg-warning"
                                            ></span
                                            >Payment On Hold</span
                                        >
                                    </td>
                                    <td><small>7533567437</small></td>
                        ...
                        ><small class="font-weight-medium"
                            ><i class="mdi mdi-chevron-down mr-2"></i>View All Order
                                History</small
                            ></a
                        >
                    </div>
                ...
                <div class="col-md-4 equel-grid">
                    <div class="grid">
                                ...
                                <div class="timeline-vertical dashboard-timeline">
                                    <div class="activity-log">
                                        ...
                                        <div class="log-details">
                                            Analytics dashboard has been created<span
                                    ...
                                    <div class="activity-log">
                                        ...
                                        <div class="log-details">
                                            Added new task: Slack home page
                                        </div>
                        ...
                        <a class="border-top px-3 py-2 d-block text-gray" href="#"
                        ><small class="font-weight-medium"
                            ><i class="mdi mdi-chevron-down mr-2"></i> View All</small
                            ></a
                        >
                    </div>
                </div>
